...
if (isset($_GET['echo'])) {
    if ($_GET['echo'] == 1) {
        ...
        <span class='material-symbols-outlined'>check_circle</span> &nbsp; Actualización realizada correctamente.
       <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
      </div></div>";
    }
    if ($_GET['echo'] == 2) {
        $mensaje = "<div class='alert alert-danger' role='alert'> <div class='modal-header'>
        <span class='material-symbols-outlined'>Close</span> &nbsp; Ocurrio un error al realizar la actualización.
       <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
      </div></div>";
    }
     if ($_GET['echo'] == 3) {
        $mensaje = "<div class='alert alert-success' role='alert'> <div class='modal-header'>
        <span class='material-symbols-outlined'>check_circle</span> &nbsp; Actualización realizada correctamente de la contraseña.
       <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
      </div></div>";
    }
    if ($_GET['echo'] == 4) {
        $mensaje = "<div class='alert alert-danger' role='alert'> <div class='modal-header'>
        <span class='material-symbols-outlined'>Close</span> &nbsp; Ocurrio un error al realizar la actualización de la contraseña.
       <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
      </div></div>";
    }
}
...
<body>
    ...
    <main>
        ...
        <!-- fin del offcanva -->
        <div class="container">
            <h1 class="text-center">Actualización del perfil</h1>
            ...
            <form action="../php/Update.php?ser=1" method="POST"> <!-- Formulario de registro  que envía los datos a Registro.php por formato POST, la imagen se envía como archivo -->
                <div class="row">
                    <div class="col-12">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../php/Update.php?pass=1" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="modal-footer">
                                <button type="submit" id="registro" disabled class="btn btn-dark">Actualizar</button>
                            </div>
                        </form>
                    </div>
