            ...
            <form action="../php/Registro.php" method="POST" enctype="multipart/form-data"> <!-- Formulario de registro  que envía los datos a Registro.php por formato POST, la imagen se envía como archivo -->
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" placeholder="Latitud decimales" name="lat" required>
                                <label for="floatingInputGrid6">Latitud en decimales</label>
                            </div>
                        </div><br>
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control" placeholder="Longitud decimales" name="lon" required>
                                <label for="floatingInputGrid5">Longitud en decimales</label>
                            </div>
                        </div><br>
                        <div class="col-md">
                            <div class="form-floating">
